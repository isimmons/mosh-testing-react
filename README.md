...
## auth-0 mocking for testing authentication

This is specific to auth0 so if using another auth system I would need to figure out the mocking for that system. See setup.ts and utils.ts for mocking auth0
